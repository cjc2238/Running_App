...
## As part of a new years resolution, I and three other friends have challenged ourselves to log at least 2017 combined miles between the four of us. These miles can be logged using any form of cardio excerscise. This repo illustrates the backend code for a Shiny App that visualizes our current progress. 

# The Application can be found here: https://learninganalytics.shinyapps.io/Running_App/
